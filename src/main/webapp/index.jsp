...
<!--HEADER/NAVBAR-->
	<nav class="nav-extended blue">
    	<div class="nav-wrapper">
      		<a href="#" class="brand-logo center">R-UNIFESSPA</a>
      		<a href="#" data-activates="menu-mobile" class="button-collapse"><i class="material-icons">menu</i></a>
      			<ul id="nav-mobile" class="right hide-on-med-and-down">
       	 			<li><a class="btn blue z-depth-0 waves-effect waves-light" href="login.jsp"><i class="material-icons right">account_circle</i>Login</a></li>
			...
			<!--grid top slider-->
      		...
      		<div class="col s12">
      			 <div class="slider blue">
    				<ul class="slides">
      					<li>
        					<img src="resources/img/ContratoRU.jpg">
      					...
      					<li>
        					<img src="resources/img/FotoRUExteno.jpg">
          ...
          <h5>Dicas e Notícias Mais Recentes</h5>
            <div class="row section no-space-row"> 
              <div class="col l4 m12 s12">
                <div class="card medium z-depth-5">
                  <div class="card-image waves-effect waves-light card-image-cover">
                    <img src="resources/img/suco_nutritivo.jpg">
                    <span class="card-title">7 sucos nutritivos para o verão</span>
                  </div>
                  <a href="#" class="add-btn-flt btn btn-floating blue z-depth-3">
                    <i class="material-icons">add</i>
                  </a>
                  <div class="card-content">
                    <p class="truncate">Sucos industrializados não substituem o suco feito com a própria fruta.</p>
                  </div>
                </div>
              </div>
              <div class="col l4 m12 s12">
                <div class="card medium z-depth-5">
                  <div class="card-image waves-effect waves-light card-image-cover">
                    <img src="resources/img/10benMaca.jpg">
                    <span class="card-title">10 dicas de alimentação para o verão</span>
                  </div>
                  <a href="#" class="add-btn-flt btn btn-floating blue z-depth-3">
                    <i class="material-icons">add</i>
                  </a>
              ...
              <div class="col l4 m12 s12">
                <div class="card medium z-depth-5">
                  <div class="card-image waves-effect waves-light card-image-cover">
                    <img src="resources/img/10dicasAlimento.jpg">
                    <span class="card-title">10 alimentos que dão mais energia e disposição ao corpo</span>
                  </div>
                  <a href="#" class="add-btn-flt btn btn-floating blue z-depth-3">
                    <i class="material-icons">add</i>
                  </a>
                  <div class="card-content">
                    <p class="truncate">Os cuidados com a alimentação são essenciais para o bom funcionamento do corpo.</p>
                  </div>
                </div>
              </div>
            </div>
...
<!--Segunda Feira-->
			<div id="Segunda" class="col s12">
				<ul class="collapsible popout" data-collapsible="accordion">
				    <li>
				      <div class="collapsible-header"><i class="material-icons">filter_drama</i>Café da Manhã</div>
				    ...
				    <li>
				      <div class="collapsible-header"><i class="material-icons">place</i>Almoço</div>
				      <div class="collapsible-body">
				      	<table class="responsive-table bordered highlight centered">
					        <thead>
					          <tr>
				    ...
				    <li>
				      <div class="collapsible-header"><i class="material-icons">whatshot</i>Jantar</div>
				      <div class="collapsible-body">
				      	<table class="responsive-table bordered highlight centered">
					        <thead>
					          <tr>
...
<footer class="page-footer blue lighten-2">
    <div class="container">
        ...
        <div class="">
        	<div class="col l6 s12">
        		<h5 class="white-text">Envie-nos sua sugestão, opinião ou reclamação:</h5>
        		<form>
        			<div class="row-no-space-row">
        				<div class="input-field col l6 s12">
        					<i class="material-icons prefix white-text">mode_edit</i>
          					<textarea id="sugest" class="materialize-textarea white-text" style="border-bottom: #f50057"></textarea>
